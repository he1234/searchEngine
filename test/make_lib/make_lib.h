...
namespace TRIM_REDUNT
{
    class Trim_redunt
    {
        public:
            ...
            void make_page_lib(const char* dir_path,const char* des_path);//提取目录文档内容制作网页库
            void stoplist_out();
        private:
            ...
            int doc_num;				//文档总数，在get_doc_num()得到
            page_word_index p_w_index;	//存放每篇文档词频最高的前PRIORITY_NUM个key,在make_page_title_abstract()生成
            page_title_index p_ta_index;//存放每篇文档的标题，摘要
